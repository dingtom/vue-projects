 ...
 * @LastEditTime: 2021-08-23 21:17:15
 * @LastEditors: Please set LastEditors
 * @Description: In User Settings Edit
 * @FilePath: \manage\src\main-prod.js
 */
// 开发环境导入了element.js quill和nprogress的样式，这是生产环境
import Vue from 'vue'
import App from './App.vue'
import router from './router'

// 注释掉 element-ui按需加载的代码
// 在 index.html的头部区域中，通过CDN加加载 element-ui的js和css样式
